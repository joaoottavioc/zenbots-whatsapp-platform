...
RESTAURANTS = {
        ...
        "products": [
            {
                ...
                "price": 19.99,
                "category": "Temakis",
                "description": "Temaki grande de salmão fresco com arroz temperado",
            },
            {
                "name": "Combinado de Salmão 40 peças",
                "price": 84.90,
                "category": "Combinados",
                "description": "Hossomaki, hot roll, niguiri, sashimi e uramaki de salmão",
            },
            {
                "name": "Combinado Clássico 18 peças",
                "price": 79.90,
                "category": "Combinados",
                "description": "Sashimi, niguiri, hossomaki e uramaki variados",
            },
            {
                "name": "Hot Rolls 20 unidades",
                "price": 29.92,
                "category": "Hot Rolls",
                "description": "Enrolado frito com arroz e recheio de salmão com cream cheese",
            },
            {
                "name": "Combinado de Uramakis 20 peças",
                "price": 49.90,
                "category": "Combinados",
                "description": "20 peças com skin, salmão e california",
            },
            {
                "name": "Sashimi de Salmão",
                "price": 9.95,
                "category": "Sashimis",
                "description": "Sashimi avulso de salmão fresco",
            },
            {
                "name": "Sushis Jhou 18 peças",
                "price": 89.90,
                "category": "Combinados",
                "description": "Sushi de salmão com cebolinha e cream cheese",
            },
            {
                "name": "Yakisoba Clássico",
                "price": 29.92,
                "category": "Pratos Quentes",
                "description": "Macarrão oriental com legumes, opções de camarão, frango ou carne",
            },
            {
                "name": "Gyoza 4 unidades",
                "price": 15.92,
                "category": "Entradas",
                "description": "Pastéis de carne e legumes fritos ou no vapor",
            },
            {
                "name": "Harumaki 4 unidades",
                "price": 15.92,
                "category": "Entradas",
                "description": "Rolinhos primavera de queijo",
            },
            {
                "name": "Chicken Katsu",
                "price": 11.92,
                "category": "Entradas",
                "description": "Tirinhas de peito de frango empanadas",
            },
            {
                "name": "Ceviche",
                "price": 31.92,
                "category": "Entradas",
                "description": "Saint peter, salmão, polvo marinados no limão",
            },
            {
                "name": "Coca-Cola",
                "price": 7.92,
        ...
        "products": [
            {
                ...
                "description": "Pão brioche, carne 100% Angus e queijo prato",
            },
            {
                "name": "Bullguer",
                "price": 33.00,
                "category": "Hambúrgueres",
                "description": "Pão brioche, carne, queijo prato, picles e molho Bullguer",
            },
            {
                "name": "Lumberjack",
                "price": 39.00,
                "category": "Hambúrgueres",
                "description": "Pão brioche, carne, queijo prato, bacon, picles e molho Bullguer",
            },
            {
                "name": "Super",
                "price": 50.00,
                "category": "Hambúrgueres",
                "description": "Pão brioche, 2 carnes 100g cada, queijo cheddar, bacon e molho bbq",
            },
            {
                "name": "Chicken Hot Honey",
                "price": 39.00,
                "category": "Hambúrgueres",
                "description": "Pão com gergelim, sobrecoxa de frango frita, queijo prato, picles, maionese e mel apimentado",
            },
            {
                "name": "Green One",
                "price": 38.00,
                "category": "Hambúrgueres",
                "description": "Pão brioche, hambúrguer de falafel com coentro, coleslaw, ovo e picles",
            },
            {
                "name": "Fisherman",
                "price": 39.00,
                "category": "Hambúrgueres",
                "description": "Pão brioche, peixe empanado, queijo prato e molho tártaro",
            },
            {
                "name": "Batatas Crinkles",
                "price": 20.00,
                "category": "Acompanhamentos",
                "description": "Batata com páprica e sal, acompanha maionese Bullguer",
            },
            {
                "name": "Onion Rings",
                "price": 21.00,
                "category": "Acompanhamentos",
                "description": "7 anéis de cebola empanados e crocantes",
            },
            {
                "name": "Cheese Bacon Fries",
                "price": 30.00,
                "category": "Acompanhamentos",
                "description": "Batatas Crinkles com queijo cremoso e bacon frito picado",
            },
            {
                "name": "Hotdog",
                "price": 18.00,
            ...
            },
            {
                ...
                "price": 28.00,
                "category": "Hot Dogs",
                "description": "Pão, salsicha enrolada no bacon e coleslaw",
            },
            {
                "name": "Brownie com Sorvete",
                "price": 25.00,
                "category": "Sobremesas",
                "description": "Brownie quente com sorvete e calda de chocolate",
            },
            {
                "name": "Milkshake",
                "price": 22.00,
                "category": "Bebidas",
                "description": "Milkshake cremoso 300ml",
            },
            {
                "name": "Refrigerante",
                "price": 9.00,
        ...
        "products": [
            {
                ...
                "description": "Pão, 1 salsicha, vinagrete, maionese e purê",
            },
            {
                "name": "Super Dog Médio",
                "price": 23.00,
                "category": "Hot Dogs Clássicos",
                "description": "Cheddar, vinagrete, curry, maionese, purê, orégano, batata palha",
            },
            {
                "name": "Tradicional Médio",
                "price": 30.00,
                "category": "Hot Dogs Clássicos",
                "description": "Carro chefe! Salsicha, cheddar, milho, vinagrete, batata palha, purê, crosta de parmesão",
            },
            {
                "name": "Tradicional Grande",
                "price": 40.00,
                "category": "Hot Dogs Clássicos",
                "description": "2 salsichas com todos os acompanhamentos e crosta de parmesão",
            },
            {
                "name": "Maximus Médio",
                "price": 32.00,
                "category": "Hot Dogs Gourmet",
                "description": "Hot dog com pepperoni, marinara mexicana picante, crosta de parmesão",
            },
            {
                "name": "Cheddar Gourmet Médio",
                "price": 27.00,
                "category": "Hot Dogs Gourmet",
                "description": "Salsicha viena, cheddar extra cremoso, cebola caramelizada com shoyu",
            },
            {
                "name": "Cheddar Bacon Grande",
                "price": 30.00,
                "category": "Hot Dogs Gourmet",
                "description": "2 salsichas, cheddar extra cremoso, bacon, orégano",
            },
            {
                "name": "Chicken Dog Grande",
                "price": 42.00,
                "category": "Hot Dogs Especiais",
                "description": "2 tiras de frango empanado, pão baguete com parmesão, cheddar, milho, vinagrete",
            },
            {
                "name": "Insano!",
                "price": 60.00,
                "category": "Hot Dogs Especiais",
                "description": "Hambúrguer artesanal 120g + salsicha, bacon, pepperoni, marinara picante",
            },
            {
                "name": "Cheese Burger",
                "price": 30.00,
                "category": "Burgers",
                "description": "Blend Angus 120g, queijo derretido, pickles, ketchup, pão brioche",
            },
            {
                "name": "Fritas Individual",
                "price": 13.00,
                "category": "Acompanhamentos",
                "description": "Porção de fritas individual",
            },
            {
                "name": "Onion Rings",
                "price": 13.00,
                "category": "Acompanhamentos",
                "description": "6 anéis de cebola empanados",
            },
            {
                "name": "Nuggets",
                "price": 13.00,
                "category": "Acompanhamentos",
                "description": "4 nuggets de frango crocantes",
            },
            {
            ...
            },
            {
                ...
                "price": 12.00,
                "category": "Sobremesas",
                "description": "Churros com recheio à escolha",
            },
        ],
    ...
    "pizza": {
        ...
        "products": [
            ...
            },
            {
                ...
                "price": 106.00,
                "category": "Pizzas Tradicionais",
                "description": "Molho de tomate, mussarela, fatias de tomate, parmesão, manjericão",
            },
            {
                "name": "Calabresa",
                "price": 106.00,
            ...
            },
            {
                ...
                "price": 108.00,
                "category": "Pizzas Tradicionais",
                "description": "Presunto, ovo, cebola, azeitona",
            },
            {
                "name": "Quatro Queijos",
                "price": 120.00,
                "category": "Pizzas Tradicionais",
                "description": "Parmesão, gorgonzola, catupiry, mussarela",
            },
            {
                "name": "Frango",
                "price": 118.00,
            ...
            },
            {
                ...
                "description": "Pepperoni fatiado com mussarela",
            },
            {
                "name": "Camarão",
                "price": 215.00,
                "category": "Pizzas Especiais",
                "description": "Camarão temperado no alho, azeite, cebolinha e salsa",
            },
            {
                "name": "Carne Seca",
                "price": 119.00,
                "category": "Pizzas Especiais",
                "description": "Carne seca desfiada, cebola, mussarela, catupiry",
            },
            {
            ...
            },
            {
                ...
                "price": 103.00,
                "category": "Massas",
                "description": "Lasanha com molho de tomate e mussarela",
            },
            {
                "name": "Maceditas",
                "price": 30.00,
                "category": "Entradas",
                "description": "Pedacinhos de massa de pizza",
            },
            {
                "name": "Coca-Cola Lata",
                "price": 9.80,
    ...
    "acai": {
        ...
        "products": [
            {
                "name": "Açaí na Tigela 200ml",
                "price": 14.00,
                "category": "Açaí na Tigela",
                "description": "Açaí puro na tigela com complementos à escolha",
            },
            {
            ...
            },
            {
                ...
                "price": 24.00,
                "category": "Potes",
                "description": "Pote de açaí 500g para viagem",
            },
            {
                "name": "Pote 1kg",
                "price": 39.00,
                "category": "Potes",
                "description": "Pote de açaí 1,02kg para viagem",
            },
            {
                "name": "Creme de Cupuaçu 300ml",
                "price": 20.00,
                "category": "Cremes",
                "description": "Tigela de creme de cupuaçu 300ml",
            },
            {
                "name": "Açaí com Cupuaçu 300ml",
                "price": 22.00,
                "category": "Casadinhos",
                "description": "Mix de açaí com cupuaçu 300ml",
            },
            {
                "name": "Taça Trufada com Creme de Avelã",
                "price": 47.00,
                "category": "Taças Trufadas",
                "description": "Taça de açaí trufado com creme de avelã premium",
            },
            {
                "name": "Suco de Açaí 500ml",
                "price": 20.00,
                "category": "Sucos",
                "description": "Suco de açaí puro 500ml",
            },
            {
                "name": "Suco de Açaí com Morango 500ml",
                "price": 18.90,
                "category": "Sucos",
                "description": "Suco de açaí batido com morango 500ml",
            },
            {
            ...
            },
            {
                ...
                "description": "Porção extra de granola 30g",
            },
            {
    ...
    async with httpx.AsyncClient(base_url=BASE_URL, timeout=30) as client:
        ...
        for label, rdata in RESTAURANTS.items():
            ...
            if bot_resp.status_code == 201:
                ...
                bot_resp.status_code == 400
                and "already exists" in bot_resp.text.lower()
            ):
                # Bot already exists — find it
                bots_resp = await client.get("/bots", headers=headers)
                all_bots = bots_resp.json()
                existing = [
                    b for b in all_bots if b.get("restaurant_name") == rdata["name"]
                ]
                if existing:
                    bot_id = existing[0]["id"]
                    print(
                        f"  Bot already exists id={bot_id}, skipping product creation"
                    )
            ...
            for i, prod in enumerate(rdata["products"]):
                ...
                if p_resp.status_code == 201:
                    ...
                    status = (
                        " (will be unavailable)"
                        if i in rdata["unavailable_indices"]
                        else ""
                    )
                    print(f"  + {prod['name']} (id={pid}){status}")
                else:
                    print(
                        f"  FAIL {prod['name']}: {p_resp.status_code} {p_resp.text[:100]}"
                    )
            ...
            for idx in rdata["unavailable_indices"]:
                ...
                if pid:
                    ...
                    if u_resp.status_code == 200:
                        print(
                            f"  [UNAVAIL] Marked unavailable: {rdata['products'][idx]['name']}"
                        )
                    else:
        ...
        print(
            "  Subscriptions must be created via DB. Run the test file which handles this."
        )
